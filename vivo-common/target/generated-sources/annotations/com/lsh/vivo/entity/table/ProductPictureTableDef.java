...
public class ProductPictureTableDef extends TableDef {
 ...
 @author ASUS
     */
    public static final ProductPictureTableDef PRODUCT_PICTURE = new ProductPictureTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, URL, MASTER, STATUS, CREATOR, MODIFIER, REVISION, CREATOR_ID, PRODUCT_ID, CREATE_TIME, MODIFIER_ID, DESCRIPTION, MODIFIED_TIME};

    public ProductPictureTableDef() {
        super("", "pdp");
    }
