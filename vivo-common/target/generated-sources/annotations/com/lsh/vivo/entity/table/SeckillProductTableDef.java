...
public class SeckillProductTableDef extends TableDef {
 ...
 @TableName seckill_product
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, STATUS, CREATOR, END_TIME, MODIFIER, REVISION, CREATOR_ID, PRODUCT_ID, START_TIME, CREATE_TIME, MODIFIER_ID, SECKILL_NUM, MODIFIED_TIME, SECKILL_PRICE};

    public SeckillProductTableDef() {
        super("", "seckill_product");
    }
